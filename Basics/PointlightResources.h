...
{
	class PointlightRootSignature : public RootSignature
	{
	public:
	...
	class PointlightRender : public RenderMethod
	{
	public:
		virtual ~PointlightRender() {}
	...
	private:
		...
		std::unique_ptr<ConstantBuffer<CBPointlightData>> m_upPointlightCBuffer = nullptr;
